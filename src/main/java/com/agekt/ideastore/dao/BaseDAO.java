...
public interface BaseDAO<T, ID extends Serializable> {
    ...
    T findObjectBySql(String tablename, String filed, Object o);
     ...
     * @return
     */
    List<T> findByPages(String tablename, String filed, Object o, int start, int pageNumber);
     ...
     * @return
     */
    Long findCount(String tablename, LinkedHashMap<String, Object> map);
}
